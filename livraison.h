...
public:
    ...
    QSqlQueryModel* search(QString keyword);
    QSqlQueryModel* trierParDateSortie();
    QMap<QString, int> statistiquesLivraisonsParMois() const;
    QList<Livraison> obtenirToutesLesLivraisons() const;
    QSqlQueryModel* trierParDateArrive();
